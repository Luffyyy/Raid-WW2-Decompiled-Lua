...
if not VehicleOperatorUnitElement then
	slot2 = MissionElement
	slot0 = class(slot1)
end

VehicleOperatorUnitElement = slot0
...
VehicleOperatorUnitElement._build_panel = function (self, panel, panel_sizer)
	...
	slot10 = "Select an operation for the selected elements"
	...
	toolbar.add_tool(EWS, toolbar, "ADD_UNIT_LIST", "Add unit from unit list", CoreEws.image_path("Specify the amount of damage."))
