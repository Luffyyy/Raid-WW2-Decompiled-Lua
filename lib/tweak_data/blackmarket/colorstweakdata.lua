BlackMarketTweakData._init_colors = function (self)
	...
	slot12 = 255
	local magenta = Color(slot8, 255, 255, 0) / 255
	slot13 = 255
	local cyan = Color(255, 255, 0, 255) / 255
	slot14 = 191
	local light_gray = Color(255, 255, 191, 191) / 255
	slot15 = 128
	local gray = Color(255, 255, 128, 128) / 255
	slot16 = 64
	local dark_gray = Color(255, 255, 64, 64) / 255
	slot17 = 9
	local blood_red = Color(255, 255, 138, 17) / 255
	slot18 = 15
	local orange = Color(255, 255, 255, 94) / 255
	slot19 = 35
	local light_brown = Color(255, 255, 204, 115) / 255
	slot20 = 76
	local bright_yellow = Color(255, 255, 255, 207) / 255
	slot21 = 81
	local lime_green = Color(255, 255, 0, 166) / 255
	slot22 = 220
	local purple = Color(255, 255, 154, 68) / 255
	slot23 = 230
	local pink = Color(255, 255, 255, 122) / 255
	slot24 = 13
	local brown = Color(255, 255, 128, 70) / 255
	slot25 = 86
	local navy_blue = Color(255, 255, 40, 52) / 255
	slot26 = 168
	local matte_blue = Color(255, 255, 56, 97) / 255
	slot27 = 50
	local olive_green = Color(255, 255, 72, 90) / 255
	slot28 = 84
	local gray_blue = Color(255, 255, 12, 68) / 255
	slot29 = 238
	local light_blue = Color(255, 255, 126, 198) / 255
	slot30 = 151
	local bone_white = Color(255, 255, 255, 238) / 255
	slot31 = 157
	local turquoise = Color(255, 255, 0, 209) / 255
	slot32 = 144
	local matte_purple = Color(255, 255, 107, 84) / 255
	slot33 = 53
	local coral_red = Color(255, 255, 213, 36) / 255
	slot34 = 54
	local leaf_green = Color(255, 255, 104, 191) / 255
	slot35 = 9
	local dark_green = Color(255, 255, 7, 61) / 255
	slot36 = 7
	local warm_yellow = Color(255, 255, 250, 157) / 255
	slot37 = 22
	local dark_red = Color(255, 255, 110, 15) / 255
	slot38 = 199
	local cobalt_blue = Color(255, 255, 0, 93) / 255
	slot39 = 87
	local toxic_green = Color(255, 255, 167, 248) / 255
	slot40 = 0
	local nothing = Color(255, 0, 0, 0) / 255
