slot2 = "lib/tweak_data/WeaponFactoryTweakData"
...
function WeaponTweakData:init(tweak_data)
	...
	self._init_data_npc_melee(tweak_data)

	slot7 = tweak_data

	self._init_data_player_weapons(tweak_data, self)
	...
	self._init_data_garand_golden_npc(tweak_data)
	...
	slot7 = difficulty_index

	self._init_data_tiger_main_gun_module_npc(tweak_data, self)

	slot7 = difficulty_index

	self._init_data_tiger_machinegun_module_npc(tweak_data, self)

	slot7 = difficulty_index

	self._init_data_junker_machinegun_module_npc(tweak_data, self)
	...
	self._init_data_spotting_optics_npc(tweak_data)

	slot7 = difficulty_index

	self._init_data_m42_flammenwerfer_npc(tweak_data, self)

	slot6 = self

	self._init_data_panzerfaust_60_npc(tweak_data)
...
function WeaponTweakData:_init_data_mg42_npc()
	...
	slot3 = self.mg42_npc
	self.mg42_secondary_npc = deep_clone(1)
...
function WeaponTweakData:_init_data_c45_npc()
	...
	slot3 = self.c45_npc
	self.c45_primary_npc = deep_clone(1)
...
function WeaponTweakData:_init_data_m4_npc()
	...
	slot3 = self.m4_npc
	self.m4_secondary_npc = deep_clone(1)
...
function WeaponTweakData:_init_data_mp5_npc()
	...
	slot3 = self.mp5_npc
	self.mp5_tactical_npc = deep_clone(1)
	self.mp5_tactical_npc.has_suppressor = "suppressed_a"
	slot3 = self.mp5_npc
	self.ump_npc = deep_clone("suppressed_a")
...
function WeaponTweakData:_init_data_player_weapons(tweak_data)
	...
	if SystemInfo.platform(slot17) == Idstring(SystemInfo) then
	...
	slot18 = autohit_rifle_default
	aim_assist_rifle_default = deep_clone(slot17)
	slot18 = autohit_pistol_default
	aim_assist_pistol_default = deep_clone(slot17)
	slot18 = autohit_shotgun_default
	aim_assist_shotgun_default = deep_clone(slot17)
	slot18 = autohit_lmg_default
	aim_assist_lmg_default = deep_clone(slot17)
	slot18 = autohit_snp_default
	aim_assist_snp_default = deep_clone(slot17)
	slot18 = autohit_smg_default
	aim_assist_smg_default = deep_clone(slot17)
	slot18 = autohit_minigun_default
	aim_assist_minigun_default = deep_clone(slot17)
	...
	self._init_stats(5000)

	self.factory = WeaponFactoryTweakData.new(5000)
	local autohit_data = {
	...
	self._init_new_weapons(WeaponFactoryTweakData, self)

	slot21 = self

	self._collect_all_fps_animation_weights(WeaponFactoryTweakData)
...
function WeaponTweakData:_collect_all_fps_animation_weights()
	...
	for weapon_part_name, weapon_part_data in pairs(slot2) do
		if weapon_part_data and weapon_part_data.fps_animation_weight then
			slot9 = weapon_part_data.fps_animation_weight

			table.insert(slot7, self._all_fps_animation_weights)
		end
	end
...
function WeaponTweakData:_init_stats()
	...
	for i = -10, 50, 2 do
		...
		table.insert(slot6, self.stats.extra_ammo)
	end
	...
	for i = -100, 100, 5 do
		...
		table.insert(slot6, self.stats.total_ammo_mod)
	end
...
function WeaponTweakData:_init_new_weapons(weapon_data)
	...
	self._init_flamethrower_mk2(10, self)

	slot7 = weapon_data

	self._init_m1911(10, self)

	slot7 = weapon_data

	self._init_c96(10, self)

	slot7 = weapon_data

	self._init_webley(10, self)

	slot7 = weapon_data

	self._init_thompson(10, self)

	slot7 = weapon_data

	self._init_sten_mk2(10, self)

	slot7 = weapon_data

	self._init_m1_garand(10, self)

	slot7 = weapon_data

	self._init_m1918_bar(10, self)

	slot7 = weapon_data

	self._init_m1903_springfield(10, self)

	slot7 = weapon_data

	self._init_m1912_winchester(10, self)

	slot7 = weapon_data

	self._init_mp38(10, self)

	slot7 = weapon_data

	self._init_m1_carbine(10, self)

	slot7 = weapon_data

	self._init_mp44(10, self)

	slot7 = weapon_data

	self._init_mg42(10, self)

	slot7 = weapon_data

	self._init_mosin(10, self)

	slot7 = weapon_data

	self._init_sterling(10, self)

	slot7 = weapon_data

	self._init_geco(10, self)

	slot7 = weapon_data

	self._init_dp28(10, self)

	slot7 = weapon_data

	self._init_tt33(10, self)

	slot7 = weapon_data

	self._init_ithaca(10, self)

	slot7 = weapon_data

	self._init_kar_98k(10, self)

	slot7 = weapon_data

	self._init_bren(10, self)

	slot7 = weapon_data

	self._init_lee_enfield(10, self)

	slot7 = weapon_data

	self._init_browning(10, self)

	slot7 = weapon_data

	self._init_shotty(10, self)
...
function WeaponTweakData:_init_flamethrower_mk2(weapon_data)
	...
	slot7 = 1
	self.flamethrower_mk2.AMMO_PICKUP = self._pickup_chance(self.flamethrower_mk2.NR_CLIPS_MAX, self, 0)
...
function WeaponTweakData:_init_c96(weapon_data)
	...
	slot7 = 1
	self.c96.AMMO_PICKUP = self._pickup_chance(self.c96.NR_CLIPS_MAX, self, self.c96.AMMO_MAX)
...
function WeaponTweakData:_init_tt33(weapon_data)
	...
	slot7 = 1
	self.tt33.AMMO_PICKUP = self._pickup_chance(self.tt33.NR_CLIPS_MAX, self, self.tt33.AMMO_MAX)
...
function WeaponTweakData:_init_webley(weapon_data)
	...
	slot7 = 1
	self.webley.AMMO_PICKUP = self._pickup_chance(self.webley.NR_CLIPS_MAX, self, self.webley.AMMO_MAX)
...
function WeaponTweakData:_init_m1911(weapon_data)
	...
	slot7 = 1
	self.m1911.AMMO_PICKUP = self._pickup_chance(self.m1911.NR_CLIPS_MAX, self, self.m1911.AMMO_MAX)
...
function WeaponTweakData:_init_m1912_winchester(weapon_data)
	...
	slot7 = 1
	self.m1912.AMMO_PICKUP = self._pickup_chance(self.m1912.NR_CLIPS_MAX, self, self.m1912.AMMO_MAX)
...
function WeaponTweakData:_init_ithaca(weapon_data)
	...
	slot7 = 1
	self.ithaca.AMMO_PICKUP = self._pickup_chance(self.ithaca.NR_CLIPS_MAX, self, self.ithaca.AMMO_MAX)
...
function WeaponTweakData:_init_browning(weapon_data)
	...
	slot7 = 1
	self.browning.AMMO_PICKUP = self._pickup_chance(self.browning.NR_CLIPS_MAX, self, self.browning.AMMO_MAX)
...
function WeaponTweakData:_init_shotty(weapon_data)
	...
	slot7 = 1
	self.shotty.AMMO_PICKUP = self._pickup_chance(self.shotty.NR_CLIPS_MAX, self, self.shotty.AMMO_MAX)
...
function WeaponTweakData:_init_geco(weapon_data)
	...
	slot7 = 1
	self.geco.AMMO_PICKUP = self._pickup_chance(self.geco.NR_CLIPS_MAX, self, self.geco.AMMO_MAX)
...
function WeaponTweakData:_init_sten_mk2(weapon_data)
	...
	slot7 = 2
	self.sten.AMMO_PICKUP = self._pickup_chance(self.sten.NR_CLIPS_MAX, self, self.sten.AMMO_MAX)
...
function WeaponTweakData:_init_thompson(weapon_data)
	...
	slot7 = 2
	self.thompson.AMMO_PICKUP = self._pickup_chance(self.thompson.NR_CLIPS_MAX, self, self.thompson.AMMO_MAX)
...
function WeaponTweakData:_init_mp38(weapon_data)
	...
	slot7 = 2
	self.mp38.AMMO_PICKUP = self._pickup_chance(self.mp38.NR_CLIPS_MAX, self, self.mp38.AMMO_MAX)
...
function WeaponTweakData:_init_sterling(weapon_data)
	...
	slot7 = 2
	self.sterling.AMMO_PICKUP = self._pickup_chance(self.sterling.NR_CLIPS_MAX, self, self.sterling.AMMO_MAX)
...
function WeaponTweakData:_init_m1_carbine(weapon_data)
	...
	slot7 = 2
	self.carbine.AMMO_PICKUP = self._pickup_chance(self.carbine.NR_CLIPS_MAX, self, self.carbine.AMMO_MAX)
...
function WeaponTweakData:_init_mp44(weapon_data)
	...
	slot7 = 2
	self.mp44.AMMO_PICKUP = self._pickup_chance(self.mp44.NR_CLIPS_MAX, self, self.mp44.AMMO_MAX)
	...
	self.m1918.kick = {
		...
		formula = function (x)
			if x == 0 then
				...
				return math.min(slot2, math.pow(2, x))
			end
...
function WeaponTweakData:_init_mg42(weapon_data)
	...
	slot7 = -7.5
	self.mg42.bipod_weapon_translation = Vector3(slot4, -8.5, 20)
	...
	slot7 = 1
	self.mg42.AMMO_PICKUP = self._pickup_chance(self.mg42.NR_CLIPS_MAX, self, self.mg42.AMMO_MAX)
