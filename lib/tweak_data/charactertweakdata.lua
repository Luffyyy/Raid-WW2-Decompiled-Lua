...
function CharacterTweakData:init(tweak_data)
	...
	slot5 = tweak_data
	local presets = self._presets(slot3, self)
	self.presets = presets
	slot5 = self

	self._init_dismemberment_data(self)

	slot6 = presets

	self._init_german_commander(self, self)

	slot6 = presets

	self._init_german_og_commander(self, self)

	slot6 = presets

	self._init_german_officer(self, self)

	slot6 = presets

	self._init_german_grunt_light(self, self)

	slot6 = presets

	self._init_german_grunt_mid(self, self)

	slot6 = presets

	self._init_german_grunt_heavy(self, self)

	slot6 = presets

	self._init_german_light(self, self)

	slot6 = presets

	self._init_german_heavy(self, self)

	slot6 = presets

	self._init_german_gasmask(self, self)

	slot6 = presets

	self._init_german_commander_backup(self, self)

	slot6 = presets

	self._init_german_fallschirmjager_light(self, self)

	slot6 = presets

	self._init_german_fallschirmjager_heavy(self, self)

	slot6 = presets

	self._init_german_waffen_ss(self, self)

	slot6 = presets

	self._init_german_gebirgsjager_light(self, self)

	slot6 = presets

	self._init_german_gebirgsjager_heavy(self, self)

	slot6 = presets

	self._init_german_flamer(self, self)

	slot6 = presets

	self._init_german_sniper(self, self)

	slot6 = presets

	self._init_german_spotter(self, self)

	slot6 = presets

	self._init_soviet_nkvd_int_security_captain(self, self)

	slot6 = presets

	self._init_soviet_nkvd_int_security_captain_b(self, self)

	slot6 = presets

	self._init_russian(self, self)

	slot6 = presets

	self._init_german(self, self)

	slot6 = presets

	self._init_american(self, self)

	slot6 = presets

	self._init_british(self, self)

	slot6 = presets

	self._init_civilian(self, self)

	slot6 = presets

	self._init_escort(self, self)
...
function CharacterTweakData:_init_russian(presets)
	...
	slot5 = presets.hurt_severities.only_explosion_hurts
	self.russian.damage.hurt_severity = deep_clone(slot4)
	self.russian.weapon = deep_clone(slot4)
	self.russian.HEALTH_INIT = 200
	slot6 = "units/vanilla/weapons/wpn_npc_usa_garand/wpn_npc_usa_garand"
	slot6 = "units/vanilla/weapons/wpn_npc_usa_garand/wpn_npc_usa_garand"
	self.russian.weapon.weapons_of_choice = {
		primary = Idstring(presets.weapon.gang_member),
		secondary = Idstring(presets.weapon.gang_member)
	}
...
function CharacterTweakData:_init_german(presets)
	...
	slot5 = presets.hurt_severities.only_explosion_hurts
	self.german.damage.hurt_severity = deep_clone(slot4)
	self.german.weapon = deep_clone(slot4)
	self.german.HEALTH_INIT = 200
	slot6 = "units/vanilla/weapons/wpn_npc_smg_thompson/wpn_npc_smg_thompson"
	slot6 = "units/vanilla/weapons/wpn_npc_smg_thompson/wpn_npc_smg_thompson"
...
function CharacterTweakData:_init_british(presets)
	...
	slot5 = presets.hurt_severities.only_explosion_hurts
	self.british.damage.hurt_severity = deep_clone(slot4)
	self.british.weapon = deep_clone(slot4)
...
function CharacterTweakData:_init_american(presets)
	...
	slot5 = presets.hurt_severities.only_explosion_hurts
	self.american.damage.hurt_severity = deep_clone(slot4)
	self.american.weapon = deep_clone(slot4)
...
function CharacterTweakData:_init_civilian(presets)
	...
	slot4 = self.civilian
	self.civilian_female = deep_clone(presets.vision.civilian)
...
function CharacterTweakData:_init_dismemberment_data(presets)
	...
	dismembers[Idstring(slot4).key(slot4)] = "dismember_head"
	slot5 = "body"
	slot5 = Idstring("dismember_head")
	dismembers[Idstring("dismember_head").key("dismember_head")] = "dismember_body_top"
	slot5 = "hit_Head"
	slot5 = Idstring("dismember_body_top")
	dismembers[Idstring("dismember_body_top").key("dismember_body_top")] = "dismember_head"
	slot5 = "hit_Body"
	slot5 = Idstring("dismember_head")
	dismembers[Idstring("dismember_head").key("dismember_head")] = "dismember_body_top"
	slot5 = "hit_RightUpLeg"
	slot5 = Idstring("dismember_body_top")
	dismembers[Idstring("dismember_body_top").key("dismember_body_top")] = "dismember_r_upper_leg"
	slot5 = "hit_LeftUpLeg"
	slot5 = Idstring("dismember_r_upper_leg")
	dismembers[Idstring("dismember_r_upper_leg").key("dismember_r_upper_leg")] = "dismember_l_upper_leg"
	slot5 = "hit_RightArm"
	slot5 = Idstring("dismember_l_upper_leg")
	dismembers[Idstring("dismember_l_upper_leg").key("dismember_l_upper_leg")] = "dismember_r_upper_arm"
	slot5 = "hit_LeftArm"
	slot5 = Idstring("dismember_r_upper_arm")
	dismembers[Idstring("dismember_r_upper_arm").key("dismember_r_upper_arm")] = "dismember_l_upper_arm"
	slot5 = "hit_RightForeArm"
	slot5 = Idstring("dismember_l_upper_arm")
	dismembers[Idstring("dismember_l_upper_arm").key("dismember_l_upper_arm")] = "dismember_r_lower_arm"
	slot5 = "hit_LeftForeArm"
	slot5 = Idstring("dismember_r_lower_arm")
	dismembers[Idstring("dismember_r_lower_arm").key("dismember_r_lower_arm")] = "dismember_l_lower_arm"
	slot5 = "hit_RightLeg"
	slot5 = Idstring("dismember_l_lower_arm")
	dismembers[Idstring("dismember_l_lower_arm").key("dismember_l_lower_arm")] = "dismember_r_lower_leg"
	slot5 = "hit_LeftLeg"
	slot5 = Idstring("dismember_r_lower_leg")
	dismembers[Idstring("dismember_r_lower_leg").key("dismember_r_lower_leg")] = "dismember_l_lower_leg"
	slot5 = "rag_Head"
	slot5 = Idstring("dismember_l_lower_leg")
	dismembers[Idstring("dismember_l_lower_leg").key("dismember_l_lower_leg")] = "dismember_head"
	slot5 = "rag_RightUpLeg"
	slot5 = Idstring("dismember_head")
	dismembers[Idstring("dismember_head").key("dismember_head")] = "dismember_r_upper_leg"
	slot5 = "rag_LeftUpLeg"
	slot5 = Idstring("dismember_r_upper_leg")
	dismembers[Idstring("dismember_r_upper_leg").key("dismember_r_upper_leg")] = "dismember_l_upper_leg"
	slot5 = "rag_RightArm"
	...
	slot5 = Idstring("dismember_r_upper_arm")
	dismembers[Idstring("dismember_r_upper_arm").key("dismember_r_upper_arm")] = "dismember_l_upper_arm"
	slot5 = "rag_RightForeArm"
	slot5 = Idstring("dismember_l_upper_arm")
	dismembers[Idstring("dismember_l_upper_arm").key("dismember_l_upper_arm")] = "dismember_r_lower_arm"
	slot5 = "rag_LeftForeArm"
	slot5 = Idstring("dismember_r_lower_arm")
	dismembers[Idstring("dismember_r_lower_arm").key("dismember_r_lower_arm")] = "dismember_l_lower_arm"
	slot5 = "rag_RightLeg"
	slot5 = Idstring("dismember_l_lower_arm")
...
function CharacterTweakData:_init_german_grunt_light(presets)
	...
	slot4 = self.german_grunt_light
	self.german_grunt_light_mp38 = clone("german_grunt_light_body")
	slot4 = self.german_grunt_light
	self.german_grunt_light_kar98 = clone("german_grunt_light_body")
	slot4 = self.german_grunt_light
	self.german_grunt_light_shotgun = clone("german_grunt_light_body")
	slot5 = "german_gebirgsjager_light"

	table.insert("german_grunt_light_body", self._enemies_list)

	slot5 = "german_grunt_light_mp38"

	table.insert("german_grunt_light_body", self._enemies_list)

	slot5 = "german_grunt_light_kar98"

	table.insert("german_grunt_light_body", self._enemies_list)

	slot5 = "german_grunt_light_shotgun"
...
function CharacterTweakData:_init_german_grunt_mid(presets)
	...
	slot4 = self.german_grunt_mid
	self.german_grunt_mid_mp38 = clone("german_grunt_mid_body")
	slot4 = self.german_grunt_mid
	self.german_grunt_mid_kar98 = clone("german_grunt_mid_body")
	slot4 = self.german_grunt_mid
	self.german_grunt_mid_shotgun = clone("german_grunt_mid_body")
	slot5 = "german_grunt_mid"

	table.insert("german_grunt_mid_body", self._enemies_list)

	slot5 = "german_grunt_mid_mp38"

	table.insert("german_grunt_mid_body", self._enemies_list)

	slot5 = "german_grunt_mid_kar98"

	table.insert("german_grunt_mid_body", self._enemies_list)

	slot5 = "german_grunt_mid_shotgun"
...
function CharacterTweakData:_init_german_grunt_heavy(presets)
	...
	slot4 = self.german_grunt_heavy
	self.german_grunt_heavy_mp38 = clone("german_grunt_body")
	slot4 = self.german_grunt_heavy
	self.german_grunt_heavy_kar98 = clone("german_grunt_body")
	slot4 = self.german_grunt_heavy
	self.german_grunt_heavy_shotgun = clone("german_grunt_body")
...
function CharacterTweakData:_init_german_gebirgsjager_light(presets)
	...
	slot4 = self.german_gebirgsjager_light
	self.german_gebirgsjager_light_mp38 = clone("gebirgsjager_light_body")
	slot4 = self.german_gebirgsjager_light
	self.german_gebirgsjager_light_kar98 = clone("gebirgsjager_light_body")
	slot4 = self.german_gebirgsjager_light
	self.german_gebirgsjager_light_shotgun = clone("gebirgsjager_light_body")
	slot5 = "german_gebirgsjager_light"

	table.insert("gebirgsjager_light_body", self._enemies_list)

	slot5 = "german_gebirgsjager_light_mp38"

	table.insert("gebirgsjager_light_body", self._enemies_list)

	slot5 = "german_gebirgsjager_light_kar98"

	table.insert("gebirgsjager_light_body", self._enemies_list)

	slot5 = "german_gebirgsjager_light_shotgun"
...
function CharacterTweakData:_init_german_gebirgsjager_heavy(presets)
	...
	slot4 = self.german_gebirgsjager_heavy
	self.german_gebirgsjager_heavy_mp38 = clone("gebirgsjager_heavy_body")
	slot4 = self.german_gebirgsjager_heavy
	self.german_gebirgsjager_heavy_kar98 = clone("gebirgsjager_heavy_body")
	slot4 = self.german_gebirgsjager_heavy
	self.german_gebirgsjager_heavy_shotgun = clone("gebirgsjager_heavy_body")
	slot5 = "german_gebirgsjager_heavy"

	table.insert("gebirgsjager_heavy_body", self._enemies_list)

	slot5 = "german_gebirgsjager_heavy_mp38"

	table.insert("gebirgsjager_heavy_body", self._enemies_list)

	slot5 = "german_gebirgsjager_heavy_kar98"

	table.insert("gebirgsjager_heavy_body", self._enemies_list)

	slot5 = "german_gebirgsjager_heavy_shotgun"
...
function CharacterTweakData:_init_german_light(presets)
	...
	self.german_light_kar98 = clone("german_black_waffen_sentry_light_body")
	slot4 = self.german_light
	self.german_light_shotgun = clone("german_black_waffen_sentry_light_body")
	slot5 = "german_light"

	table.insert("german_black_waffen_sentry_light_body", self._enemies_list)

	slot5 = "german_light_kar98"

	table.insert("german_black_waffen_sentry_light_body", self._enemies_list)

	slot5 = "german_light_shotgun"
...
function CharacterTweakData:_init_german_heavy(presets)
	...
	slot4 = self.german_heavy
	self.german_heavy_mp38 = clone("german_black_waffen_sentry_heavy_body")
	slot4 = self.german_heavy
	self.german_heavy_kar98 = clone("german_black_waffen_sentry_heavy_body")
	slot4 = self.german_heavy
	self.german_heavy_shotgun = clone("german_black_waffen_sentry_heavy_body")
	slot5 = "german_heavy"

	table.insert("german_black_waffen_sentry_heavy_body", self._enemies_list)

	slot5 = "german_heavy_mp38"

	table.insert("german_black_waffen_sentry_heavy_body", self._enemies_list)

	slot5 = "german_heavy_kar98"

	table.insert("german_black_waffen_sentry_heavy_body", self._enemies_list)

	slot5 = "german_heavy_shotgun"
...
function CharacterTweakData:_init_german_fallschirmjager_light(presets)
	...
	slot4 = self.german_fallschirmjager_light
	self.german_fallschirmjager_light_mp38 = clone("german_fallschirmjager_light_body")
	slot4 = self.german_fallschirmjager_light
	self.german_fallschirmjager_light_kar98 = clone("german_fallschirmjager_light_body")
	slot4 = self.german_fallschirmjager_light
	self.german_fallschirmjager_light_shotgun = clone("german_fallschirmjager_light_body")
	slot5 = "german_fallschirmjager_light"

	table.insert("german_fallschirmjager_light_body", self._enemies_list)

	slot5 = "german_fallschirmjager_light_mp38"

	table.insert("german_fallschirmjager_light_body", self._enemies_list)

	slot5 = "german_fallschirmjager_light_kar98"

	table.insert("german_fallschirmjager_light_body", self._enemies_list)

	slot5 = "german_fallschirmjager_light_shotgun"
...
function CharacterTweakData:_init_german_gasmask(presets)
	...
	slot4 = self.german_gasmask
	self.german_gasmask_shotgun = deep_clone("german_black_waffen_sentry_gasmask_body")
	self.german_gasmask_shotgun.move_speed = presets.move_speed.fast
	self.german_gasmask_shotgun.HEALTH_INIT = 500
	slot5 = "german_gasmask"

	table.insert(500, self._enemies_list)
...
function CharacterTweakData:_init_german_commander_backup(presets)
	...
	slot5 = "german_light_commander_backup"

	table.insert("german_black_waffen_sentry_light_commander_body", self._enemies_list)

	slot4 = self.german_heavy
	self.german_heavy_commander_backup = deep_clone("german_black_waffen_sentry_light_commander_body")
	self.german_heavy_commander_backup.carry_tweak_corpse = "german_black_waffen_sentry_heavy_commander_body"
	slot5 = "german_heavy_commander_backup"

	table.insert("german_black_waffen_sentry_heavy_commander_body", self._enemies_list)

	slot4 = self.german_gasmask
	self.german_gasmask_commander_backup = deep_clone("german_black_waffen_sentry_heavy_commander_body")
	slot5 = "german_gasmask_commander_backup"

	table.insert("german_black_waffen_sentry_heavy_commander_body", self._enemies_list)

	slot4 = self.german_gasmask_shotgun
	self.german_gasmask_commander_backup_shotgun = deep_clone("german_black_waffen_sentry_heavy_commander_body")
	slot5 = "german_gasmask_commander_backup_shotgun"
...
function CharacterTweakData:_init_german_fallschirmjager_heavy(presets)
	...
	slot4 = self.german_fallschirmjager_heavy
	self.german_fallschirmjager_heavy_mp38 = clone("german_fallschirmjager_heavy_body")
	slot4 = self.german_fallschirmjager_heavy
	self.german_fallschirmjager_heavy_kar98 = clone("german_fallschirmjager_heavy_body")
	slot4 = self.german_fallschirmjager_heavy
	self.german_fallschirmjager_heavy_shotgun = clone("german_fallschirmjager_heavy_body")
	self.german_fallschirmjager_heavy_shotgun.HEALTH_INIT = 25
	slot5 = "german_fallschirmjager_heavy"

	table.insert(25, self._enemies_list)

	slot5 = "german_fallschirmjager_heavy_mp38"

	table.insert(25, self._enemies_list)

	slot5 = "german_fallschirmjager_heavy_kar98"

	table.insert(25, self._enemies_list)

	slot5 = "german_fallschirmjager_heavy_shotgun"
...
function CharacterTweakData:_init_german_waffen_ss(presets)
	...
	slot4 = self.german_waffen_ss
	self.german_waffen_ss_mp38 = clone("german_waffen_ss_body")
	slot4 = self.german_waffen_ss
	self.german_waffen_ss_kar98 = clone("german_waffen_ss_body")
	slot4 = self.german_waffen_ss
	self.german_waffen_ss_shotgun = clone("german_waffen_ss_body")
	self.german_waffen_ss_shotgun.HEALTH_INIT = 420
	self.german_waffen_ss_shotgun.BASE_HEALTH_INIT = 420
	slot5 = "german_waffen_ss"

	table.insert(420, self._enemies_list)

	slot5 = "german_waffen_ss_mp38"

	table.insert(420, self._enemies_list)

	slot5 = "german_waffen_ss_kar98"

	table.insert(420, self._enemies_list)

	slot5 = "german_waffen_ss_shotgun"
...
function CharacterTweakData:_init_german_commander(presets)
	...
	slot5 = "german_commander"

	table.insert(CharacterTweakData.SPECIAL_UNIT_TYPE_COMMANDER, self._enemies_list)
...
function CharacterTweakData:_init_german_officer(presets)
	...
	slot5 = "german_officer"

	table.insert("german_commander_body", self._enemies_list)
...
function CharacterTweakData:_init_soviet_nkvd_int_security_captain(presets)
	...
	slot5 = "soviet_nkvd_int_security_captain"

	table.insert("soviet_nkvd_int_security_captain_body", self._enemies_list)
...
function CharacterTweakData:_init_soviet_nkvd_int_security_captain_b(presets)
	...
	slot5 = "soviet_nkvd_int_security_captain_b"

	table.insert(4, self._enemies_list)
...
function CharacterTweakData:_init_german_flamer(presets)
	...
	slot5 = self.german_flamer.weapon

	self._process_weapon_usage_table(, self)
...
function CharacterTweakData:_init_german_sniper(presets)
	...
	slot5 = self.german_sniper.weapon

	self._process_weapon_usage_table(presets.weapon.sniper, self)
	...
	slot5 = presets.hurt_severities.base
	self.german_sniper.damage.hurt_severity = deep_clone(self)
	...
	table.insert(, self._enemies_list)
...
function CharacterTweakData:_init_german_spotter(presets)
	...
	slot5 = presets.hurt_severities.base
	self.german_spotter.damage.hurt_severity = deep_clone()
	...
	slot5 = "german_spotter"

	table.insert(CharacterTweakData.SPECIAL_UNIT_TYPE_SPOTTER, self._enemies_list)
...
function CharacterTweakData:_presets(tweak_data)
	...
	slot6 = presets.hurt_severities.base
	presets.gang_member_damage.hurt_severity = deep_clone()
	...
	slot7 = presets.vision.spotter.combat
	presets.vision.spotter.idle = deep_clone()
	...
	slot6 = presets.weapon.normal

	self._process_weapon_usage_table("ntl", self)

	slot6 = presets.weapon.good

	self._process_weapon_usage_table("ntl", self)

	slot6 = presets.weapon.expert

	self._process_weapon_usage_table("ntl", self)

	slot6 = presets.weapon.insane

	self._process_weapon_usage_table("ntl", self)

	slot6 = presets.weapon.sniper

	self._process_weapon_usage_table("ntl", self)

	slot6 = presets.weapon.gang_member
	...
	for preset_name, preset_data in pairs() do
		slot10 = preset_data.occasions

		for reason_name, reason_data in pairs(slot9) do
			local total_w = 0
			slot16 = reason_data.variations

			for variation_name, variation_data in pairs(slot15) do
	...
	slot5 = presets.move_speed

	for speed_preset_name, poses in pairs() do
		slot10 = poses

		for pose, hastes in pairs(slot9) do
...
function CharacterTweakData:_create_table_structure()
	...
	slot4 = "units/vanilla/weapons/wpn_npc_spc_m42_flammenwerfer/wpn_npc_spc_m42_flammenwerfer"
	slot4 = "units/temp/weapons/wpn_npc_spc_panzerfaust_60/wpn_npc_spc_panzerfaust_60"
	slot4 = "units/vanilla/weapons/wpn_npc_ger_k98/wpn_npc_ger_k98"
	slot4 = "units/vanilla/weapons/wpn_npc_ger_k98/wpn_npc_ger_k98_sniper"
	slot4 = "units/vanilla/weapons/wpn_npc_binocular/wpn_npc_binocular"
	slot4 = "units/vanilla/weapons/wpn_npc_ger_mp38/wpn_npc_ger_mp38"
	slot4 = "units/vanilla/weapons/wpn_npc_ger_luger/wpn_npc_ger_luger"
	slot4 = "units/vanilla/weapons/wpn_npc_ger_luger/wpn_npc_ger_luger_invisible"
	slot4 = "units/vanilla/weapons/wpn_npc_ger_stg44/wpn_npc_ger_stg44"
	slot4 = "units/vanilla/weapons/wpn_npc_usa_garand/wpn_npc_usa_garand"
	slot4 = "units/vanilla/weapons/wpn_npc_usa_m1911/wpn_npc_usa_m1911"
	slot4 = "units/vanilla/weapons/wpn_npc_smg_thompson/wpn_npc_smg_thompson"
	slot4 = "units/vanilla/weapons/wpn_npc_ger_geco/wpn_npc_ger_geco"
	slot4 = "units/vanilla/weapons/ger_shotgun_npc/ger_shotgun_npc"
	slot4 = "units/vanilla/weapons/wpn_gre_m24/wpn_gre_m24_husk"
	slot4 = "units/vanilla/weapons/wpn_fps_decoy_coin_peace/wpn_decoy_coin_peace_husk"
	slot4 = "units/vanilla/weapons/wpn_fps_gre_mills/wpn_fps_gre_mills_husk"
	slot4 = "units/vanilla/weapons/wpn_fps_gre_d343/wpn_fps_gre_d343_husk"
	slot4 = "units/upd_001/weapons/wpn_fps_gre_concrete/wpn_fps_gre_concrete_husk"
	slot4 = "units/vanilla/weapons/wpn_third_mel_m3_knife/wpn_third_mel_m3_knife"
	slot4 = "units/vanilla/weapons/wpn_third_mel_robbins_dudley_trench_push_dagger/wpn_third_mel_robbins_dudley_trench_push_dagger"
	slot4 = "units/vanilla/weapons/wpn_third_mel_german_brass_knuckles/wpn_third_mel_german_brass_knuckles"
	slot4 = "units/vanilla/weapons/wpn_third_mel_lockwood_brothers_push_dagger/wpn_third_mel_lockwood_brothers_push_dagger"
	slot4 = "units/vanilla/weapons/wpn_third_mel_bc41_knuckle_knife/wpn_third_mel_bc41_knuckle_knife"
	slot4 = "units/vanilla/weapons/wpn_third_mel_km_dagger/wpn_third_mel_km_dagger"
	slot4 = "units/vanilla/weapons/wpn_third_mel_marching_mace/wpn_third_mel_marching_mace"
	slot4 = "units/event_001_halloween/weapons/wpn_third_mel_lc14b/wpn_third_mel_lc14b"
	...
	slot4 = "units/vanilla/weapons/wpn_gre_m24/wpn_gre_m24_hand"
	slot5 = "units/vanilla/weapons/wpn_gre_m24/wpn_gre_m24_husk"
	slot3 = Idstring(Idstring(slot3))
	self.hack_weap_unit_names[Idstring(slot3).key(slot3)] = slot3
	slot4 = "units/vanilla/weapons/wpn_fps_mel_m3_knife/wpn_fps_mel_m3_knife"
	slot5 = "units/vanilla/weapons/wpn_third_mel_m3_knife/wpn_third_mel_m3_knife"
	slot3 = Idstring(Idstring(slot3))
	self.hack_weap_unit_names[Idstring(slot3).key(slot3)] = slot3
	slot4 = "units/vanilla/weapons/wpn_fps_mel_robbins_dudley_trench_push_dagger/wpn_fps_mel_robbins_dudley_trench_push_dagger"
	slot5 = "units/vanilla/weapons/wpn_third_mel_robbins_dudley_trench_push_dagger/wpn_third_mel_robbins_dudley_trench_push_dagger"
	slot3 = Idstring(Idstring(slot3))
	self.hack_weap_unit_names[Idstring(slot3).key(slot3)] = slot3
	slot4 = "units/vanilla/weapons/wpn_fps_mel_german_brass_knuckles/wpn_fps_mel_german_brass_knuckles"
	slot5 = "units/vanilla/weapons/wpn_third_mel_german_brass_knuckles/wpn_third_mel_german_brass_knuckles"
	slot3 = Idstring(Idstring(slot3))
	self.hack_weap_unit_names[Idstring(slot3).key(slot3)] = slot3
	slot4 = "units/vanilla/weapons/wpn_fps_mel_lockwood_brothers_push_dagger/wpn_fps_mel_lockwood_brothers_push_dagger"
	slot5 = "units/vanilla/weapons/wpn_third_mel_lockwood_brothers_push_dagger/wpn_third_mel_lockwood_brothers_push_dagger"
	slot3 = Idstring(Idstring(slot3))
	self.hack_weap_unit_names[Idstring(slot3).key(slot3)] = slot3
	slot4 = "units/vanilla/weapons/wpn_fps_mel_bc41_knuckle_knife/wpn_fps_mel_bc41_knuckle_knife"
	slot5 = "units/vanilla/weapons/wpn_third_mel_bc41_knuckle_knife/wpn_third_mel_bc41_knuckle_knife"
	slot3 = Idstring(Idstring(slot3))
	self.hack_weap_unit_names[Idstring(slot3).key(slot3)] = slot3
	slot4 = "units/vanilla/weapons/wpn_fps_km_dagger/wpn_fps_km_dagger"
	slot5 = "units/vanilla/weapons/wpn_third_mel_km_dagger/wpn_third_mel_km_dagger"
	slot3 = Idstring(Idstring(slot3))
	self.hack_weap_unit_names[Idstring(slot3).key(slot3)] = slot3
	slot4 = "units/vanilla/weapons/wpn_fps_marching_mace/wpn_fps_marching_mace"
	slot5 = "units/vanilla/weapons/wpn_third_mel_marching_mace/wpn_third_mel_marching_mace"
	slot3 = Idstring(Idstring(slot3))
	self.hack_weap_unit_names[Idstring(slot3).key(slot3)] = slot3
	slot4 = "units/event_001_halloween/weapons/wpn_fps_lc14b/wpn_fps_lc14b"
	slot5 = "units/event_001_halloween/weapons/wpn_third_mel_lc14b/wpn_third_mel_lc14b"
	self.hack_weap_unit_names[Idstring(slot3).key(slot3)] = Idstring(Idstring(slot3))
...
function CharacterTweakData:_process_weapon_usage_table(weap_usage_table)
	...
	for _, weap_id in ipairs(slot3) do
		...
		if usage_data then
			slot10 = usage_data.FALLOFF

			for i_range, range_data in ipairs(slot9) do
				local modes = range_data.mode
				local total = 0
				slot17 = modes

				for i_firemode, value in ipairs(slot16) do
					total = total + value
				end
				...
				for i_firemode, value in ipairs(slot17) do
...
function CharacterTweakData:_set_difficulty_1()
	...
	self._multiply_weapon_delay(slot2, self, self.presets.weapon.normal)

	slot5 = 1

	self._multiply_weapon_delay(slot2, self, self.presets.weapon.good)

	slot5 = 1

	self._multiply_weapon_delay(slot2, self, self.presets.weapon.expert)

	slot5 = 3

	self._multiply_weapon_delay(slot2, self, self.presets.weapon.sniper)

	slot5 = 11

	self._multiply_weapon_delay(slot2, self, self.presets.weapon.gang_member)
	...
	self._set_characters_weapon_preset(125, self)
...
function CharacterTweakData:_set_difficulty_2()
	...
	self._set_characters_weapon_preset(0.4, self)
...
function CharacterTweakData:_set_difficulty_3()
	...
	self._set_characters_weapon_preset(200, self)
...
function CharacterTweakData:_set_difficulty_4()
	...
	self._multiply_all_speeds(slot2, self, 2)
	...
	self._set_characters_weapon_preset(250, self)
...
function CharacterTweakData:character_map()
	...
	if TweakData._init_wip_character_map then
		...
		TweakData._init_wip_character_map(slot3)
	end
