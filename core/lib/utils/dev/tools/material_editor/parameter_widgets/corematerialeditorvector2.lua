...
if not CoreMaterialEditorVector2 then
...
CoreMaterialEditorVector2._to_slider_range = function (self, v)
	...
	slot11 = step_x
	slot6 = CoreMaterialEditorParameter.to_slider_range(slot7, self, v.x, self._parameter_info.min.x)
	slot12 = step_y
...
CoreMaterialEditorVector2._from_slider_range = function (self, v)
	...
	slot11 = step_x
	slot6 = CoreMaterialEditorParameter.from_slider_range(slot7, self, v.x, self._parameter_info.min.x)
	slot12 = step_y

	return Vector3(slot5, CoreMaterialEditorParameter.from_slider_range(self, self, v.y, self._parameter_info.min.y))
end
