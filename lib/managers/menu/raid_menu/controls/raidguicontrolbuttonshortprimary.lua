...
RaidGUIControlButtonShortPrimary.init = function (self, parent, params)
	if not params then
...
RaidGUIControlButtonShortPrimary.enable = function (self)
...
RaidGUIControlButtonShortPrimary.disable = function (self)
	slot3 = self
