...
RaidGUIControlButtonLongPrimaryDisabled.init = function (self, parent, params)
	if not params then
...
RaidGUIControlButtonLongPrimaryDisabled.show = function (self)
	slot3 = self
...
RaidGUIControlButtonLongPrimaryDisabled.hide = function (self)
	slot3 = self
